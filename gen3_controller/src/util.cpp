...
Eigen::Vector3d getPhi(Eigen::Matrix3d current_rotation, Eigen::Matrix3d desired_rotation)
{
  Eigen::Vector3d phi;
...
Eigen::Matrix3d rotationCubic(double time,
    double time_0,
    double time_f,
...
Eigen::Vector3d rotationCubicDot(double time,
    double time_0,
    double time_f,
