...
def launch_setup(context, *args, **kwargs):
    ...
    robot_eff_controller = LaunchConfiguration("robot_eff_controller")
    robot_twist_controller = LaunchConfiguration("robot_twist_controller")
    ...
    robot_eff_controller_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=[robot_eff_controller, "--inactive", "-c", "/controller_manager"],
    )

    robot_twist_controller_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=[robot_twist_controller, "--inactive", "-c", "/controller_manager"],
    )
    ...
    nodes_to_start = [
        ...
        robot_eff_controller_spawner,
        robot_twist_controller_spawner,
...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "robot_ip", description="IP address by which the robot can be reached.", default_value="192.168.1.10"
        )
    )
    declared_arguments.append(
        DeclareLaunchArgument(
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "description_file",
            default_value="kinova_7d.urdf.xacro",
